...
public class Knife extends FallingObject {

    Vector2 initialPosition;
    float width = 100;
    float height = 40;

    public Knife(Gingerbread game,float x,float y) {
        super(game);
    ...
    protected void setSprite() {
        sprite = new Sprite(game.imgManager.getRegion("kitchen_knife"));
    }
...
//        fdef.filter.maskBits = Box2dCollisionManager.FALLING_OBJECT_BIT;
    ...
    public void draw(SpriteBatch sb) {
        sb.draw(sprite,body.getPosition().x - width/game.PPM ,body.getPosition().y - height/game.PPM ,width * 2 /game.PPM,height/game.PPM * 2);
    }
